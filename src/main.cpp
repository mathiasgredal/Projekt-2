...
{
    ObjectDetector detector = ObjectDetector( "/home/mathias/Desktop/Projects/Projekt-2/assets/yolov5s-fp16.tflite", classes);

    // Load image
    QImage img("/home/mathias/Desktop/Projects/Projekt-2/assets/bus.jpg");
    if(img.isNull())
